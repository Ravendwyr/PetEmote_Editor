namespace PetEmote.Editor.Forms
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ExampleOutput = new PetEmote.Editor.Components.EmoteOutput();
			...
			// 
			this.SplitContainer_TopBottom.Panel2.Controls.Add(this.ExampleOutput);
			// 
			...
			// ExampleOutput
			// 
			resources.ApplyResources(this.ExampleOutput, "ExampleOutput");
		...
		private PetEmote.Editor.Components.EmoteOutput ExampleOutput;
    }
}
